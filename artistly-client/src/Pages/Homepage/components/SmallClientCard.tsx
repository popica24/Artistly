...
const SmallClientCard = (props: Props) => {
  ...
  return (
    <div
      ...
      className="bg-[#F3F3F3] rounded-[1.5085rem] min-w-[260px]  tablet:max-w-[90vmin] tablet:w-full flex flex-col justify-center items-center pb-4 relative h-full shadow-md tablet:shadow-none cursor-pointer
      tablet:min-h-[300px]
      "
    >
      <div className="leading-4 font-medium pb-4 h-full w-full">
        <div style={coverStyle} className="h-[120px] w-full tablet:h-[150px]" />
